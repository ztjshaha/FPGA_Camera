...
xv_boost_lib_path=C:/software/program_software/Vivado/Vivado/2019.1/tps/boost_1_64_0
...
{
  file="xsim.ini"
  lib_map_path="C:/software/program_software/Vivado/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
